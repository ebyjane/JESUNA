<div class="comment comment-<?php echo $comment->id; ?>" data-attr-id="<?php echo $comment->id; ?>" style="margin-left: <?php echo $depth*4 * 10; ?>px; display:none;">
	...
	<?php //echo $content->author->id; 
							...
							if(count($image_data)>0){
								echo CHtml::link(CHtml::image("/uploads/".$image_data->value, NULL, array('class'=> 'thumb', 'style' => 'width:30px;float:left',  'href' => "/uploads/".$image_data->value, 'title' => "/uploads/".$image_data->value)), $this->createUrl("/profile/{$id}/"));
							}else{
								echo CHtml::link(CHtml::image("/uploads/images.jpg", NULL, array('class'=> 'thumb', 'style' => 'width:30px;float:left',  'href' => "/uploads/images.jpg", 'title' => "/uploads/images.jpg")), $this->createUrl("/profile/{$id}/"));
							}	
